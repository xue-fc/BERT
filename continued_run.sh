...
bert_base_dir='/home/bert/bert/Model/uncased_L-12_H-768_A-12'
task_name='MNLI'
mode=${1}
cuda_device=0
granularity=128
pruning_type=8  # 4 5 8 999->TWVW 4->VW 8->TW2 1000->EW
pretrained_path=/home/bert/bert/Model/${task_name}_pretrained_model
STARTTIME=$( date '+%F')
...
then
	...
	--do_train=true \
	--do_eval=true \
	--data_dir=/home/bert/bert/glue_data/ \
